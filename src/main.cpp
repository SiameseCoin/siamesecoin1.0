...
uint256 hashGenesisBlock("0xb87907d6f452a02477c518df41712847f267882fcabc032b8046ba903ce10d03");
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x178ab82511e934dae30b2a72bdc7dccc3c730731c887411a0ad7369be24ee7a9");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Apple announces the iPhone 6.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1410750011; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 816310;

        if (fTestNet)
        {
            block.nTime    = 1410744350;
            block.nNonce   = 786380;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x7cfe0ffa371a454f74e6dc52bfce2dca137b4e8a0c2f0887b37fdcc003a99eb7"));
